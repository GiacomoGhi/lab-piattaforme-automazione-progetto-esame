...
- Degradation simulation runs when the pump is off. It updates all parameters every second and rotates the accelerated parameter per cycle.
...
- Applies water corrections by writing Water Digital Twin properties via HTTP when pumpSpeed > 0.
